# Objekt: Objektbereich (Multipolygon / Linie)

Beschreibt eine logische Gruppierung von Einzelobjekten oder einen thematischen Raum. Einzelobjekte werden durch Verweis (ref_objektbereich) zugeordnet. Objektbereiche können auf andere Objektbereiche verweisen (ref_objektbereich).
...
```SQL
-- DROP TABLE "obj_Objektbereich";
-- DROP TABLE "obj_Objektbereich_line";

CREATE TABLE IF NOT EXISTS "obj_Objektbereich"
-- CREATE TABLE IF NOT EXISTS "obj_Objektbereich_line" -- NB: geom!
( 	
    -- Identifikatoren
