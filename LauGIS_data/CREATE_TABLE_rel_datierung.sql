...
DROP TABLE IF EXISTS development.rel_datierung;
CREATE TABLE IF NOT EXISTS development.rel_datierung
(     
...
CONSTRAINT fkey_datierung_id FOREIGN KEY (ref_ereignis_id)
    REFERENCES development.def_datierung (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
);